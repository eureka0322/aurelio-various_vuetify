        ...
        <v-layout row wrap>
          <v-flex xs5>
            <span style="font-size: 35px; font-weight: 200; color: green;"><span
              style="font-size: 35px; font-weight: 600; color: green;">3. </span>{{TRANS('Listado de relojes')}}</span>
          </v-flex>
          <v-flex xs5>
            <v-text-field
              v-model="search"
...
<script>
  import json from '../Json/Prelojes3.json'
